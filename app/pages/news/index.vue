        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="p-8 flex flex-col flex-grow">
              ...
              <div class="mt-auto">
                <NuxtLink :to="`/news/${blog.slug}`" class="inline-flex items-center gap-2 text-sm font-bold uppercase tracking-widest text-slate-800 group-hover:text-[#e32727] transition-colors border-b-2 border-transparent group-hover:border-[#e32727] pb-1">
...
const { data: blogResponse } = await useAsyncData('news-blogs', () => $api('/public/blogs') as Promise<any>)
