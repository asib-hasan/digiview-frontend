    ...
    <div class="container mx-auto px-4 md:px-8 pt-8 md:pt-10">
      ...
      <div class="mt-12 md:mt-16 pt-8 border-t border-slate-200 print:hidden">
        ...
        <div class="py-8 min-h-[200px]">
          <div v-if="activeTab === 'description'" class="prose prose-sm md:prose-base max-w-none text-slate-600 product-description-content">
          ...
          <div v-if="activeTab === 'downloads'" class="animate-fade-in">
            ...
            <div v-if="downloads.length > 0" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
